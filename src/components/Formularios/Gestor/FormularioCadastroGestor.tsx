...
export  default function FormularioCadastroGestor(){
    ...
    return (
        <div className='flex flex-col w-2/5  justify-center p-4'>
            {
            ...
            <form onSubmit={(e)=>cadastrarUsuario(e)} className=" flex flex-col">
                ...
                <input type="codigo" value={codigo} id="codigo" placeholder="Adicione um codigo para sua conta" onChange={(e:any)=>setCodigo(e.target.value)}  className=" text-black"/>
